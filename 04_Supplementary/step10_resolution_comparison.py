...
if RES == 1.0:
    FEAT_PATH  = ROOT / "data/features/Ocean_HeatFlow_Prediction_Data_1x1deg.csv"
    OUT_PATH   = ROOT / "outputs/step10_1x1deg_results.txt"
    RES_LABEL  = "1x1°"
    ROUND_DIGS = 2
else:
    FEAT_PATH  = ROOT / "data/features/Ocean_HeatFlow_Prediction_Data_0.25x0.25deg.csv"
    OUT_PATH   = ROOT / "outputs/step10_0.25x0.25deg_results.txt"
    RES_LABEL  = "0.25x0.25°"
    ROUND_DIGS = 4
